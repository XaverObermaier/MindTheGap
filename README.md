...
- **Attention-gap recognition** — independently dated, curated records from the Norwegian Refugee Council's *The World's Most Neglected Displacement Crises in 2025* list. Missing or incomplete recognition data is shown as unknown; it is not evidence that the country's crisis is not neglected.
